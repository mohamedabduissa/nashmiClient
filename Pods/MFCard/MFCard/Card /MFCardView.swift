...
@IBDesignable public class MFCardView: UIView {
    ...
    @IBOutlet public weak var txtCvc: UITextField!
    
    @IBOutlet weak fileprivate var frontCardImage: UIImageView!
    
    @IBOutlet weak fileprivate var frontChromeView: UIView!
    
    @IBOutlet public weak var txtCardName: UITextField!
    
    @IBOutlet public weak  var txtCardNoP1: UITextField!
    @IBOutlet public weak  var txtCardNoP2: UITextField!
    @IBOutlet public weak  var txtCardNoP3: UITextField!
    @IBOutlet public weak  var txtCardNoP4: UITextField!
    
    @IBOutlet weak fileprivate var cardTypeImage: UIImageView!
    @IBOutlet public weak var viewExpiryMonth: LBZSpinner!
    @IBOutlet public  weak var viewExpiryYear: LBZSpinner!
    
    @IBOutlet weak fileprivate var controlView: UIView!
    
    @IBOutlet public weak var btnCvc: UIButton!
    ...
    public func getMonth()->String?{
        return Month(rawValue: viewExpiryMonth!.labelValue.text!)?.rawValue
    }
    public func getYear()->String?{
        return viewExpiryYear!.labelValue.text!
    }
    //MARK:
