...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    public var handleTracking: HandleTracking = .none
    ...
    public var minLabelTextSize: CGSize = .zero
    public var maxLabelTextSize: CGSize = .zero

    // UIFeedbackGenerator
    public var previousStepMinValue: CGFloat?
    public var previousStepMaxValue: CGFloat?
    ...
    public var rightHandleAccessibilityElement: UIAccessibilityElement {
    ...
    public func percentageAlongLine(for value: CGFloat) -> CGFloat {
...
public final class RangeSeekSliderRightElement: UIAccessibilityElement {
